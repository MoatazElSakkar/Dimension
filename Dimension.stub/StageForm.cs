...
namespace Dimension.stub
{
    public partial class StageForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //PyramidOfGiza.Transform(0, Transformation.Translation, -100, -20, 1);
            //PyramidOfGiza.Transform(1, Transformation.Translation, -1000, 80, 6);
            ...
            List<Point> PyramidOfGizaPointSet = new List<Point>();
            PyramidOfGizaPointSet.Add(new Point(-25, 200, 100));
            PyramidOfGizaPointSet.Add(new Point(-400, -200, 300));
            PyramidOfGizaPointSet.Add(new Point(150, -200, 200));
            PyramidOfGizaPointSet.Add(new Point(350, -200, 400));
            ...
            PyramidOfGiza.addStructure(Giza_Khfraa);
            PyramidOfGiza.addStructure(Giza_Mankura);
            PyramidOfGiza.SetLightSource(new Point(-1000, 100, 300), System.Drawing.Color.White);

            PyramidOfGiza.Transform(0, Transformation.Translation, -100, -20, 100);
            PyramidOfGiza.Transform(1, Transformation.Translation, -1000, 80, 600);
            PyramidOfGiza.Transform(2, Transformation.Translation, -400, 30, 300);
